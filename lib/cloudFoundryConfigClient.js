...
function loadRemote(config, request) {
    if (request === void 0) { request = rp; }
    return __awaiter(this, void 0, void 0, function () {
        var appName, profile, uri, access_token_uri, client_id, client_secret, response, access_token, ymlString;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, request.post(access_token_uri, {
...
function loadRemoteSkipAuth(config, request) {
    if (request === void 0) { request = rp; }
    return __awaiter(this, void 0, void 0, function () {
        var appName, profile, uri, ymlString;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
...
function getLoaderConfig(params, loadVcapServicesFunc) {
    ...
    if (configLocation === "remote") {
        var vcap_services = loadVcapServicesFunc(process.env.VCAP_SERVICES);
        var configServerJsonServiceName = void 0;
        ...
        var credentials = vcap_services["" + configServerJsonServiceName].find(function (cfg) { return cfg.name === configServerName; }).credentials;
